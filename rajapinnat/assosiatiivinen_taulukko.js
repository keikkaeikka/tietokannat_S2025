...
console.log("Datatype of bookArray:", typeof bookArray);

console.log("Full bookArray:", bookArray);

console.log("First row:", bookArray[0]);

console.log("First book name:", bookArray[0].name);

console.log("Number of rows:", bookArray.length);
